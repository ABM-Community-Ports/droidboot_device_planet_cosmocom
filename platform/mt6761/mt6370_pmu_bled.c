...
static void mt6370_bled_parsing_dts(void *fdt)
{
	...
	if (offset >= 0 && sub_offset >= 0) {
		val = mt6370_bled_fdt_getprop_bool(g_fdt, sub_offset, "mt,ext_en_pin");
