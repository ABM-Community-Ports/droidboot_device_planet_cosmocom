...
typedef enum {
	...
	FASTBOOT = 99,
	DOWNLOAD_BOOT = 100,
	NORMAL_BOOT_LVM_BASE = 200,
	NORMAL_BOOT_LVM_MAX = 300,
	UNKNOWN_BOOT
} BOOTMODE;
...
#if 1
#define BOOT_TAG_EMMC_PART_NUM      0x8861001D
struct boot_tag_emmc_part_num {
        char emmc_part_num[30];
};
#endif
...
#endif
		struct boot_tag_emmc_part_num emmc_part_num;
	} u;
};
