				       ...
				       char *img_name, part_hdr_t *part_hdr, uint64_t *img_start_addr)
{
	...
	pal_log_err("ZBOOT LOAD_IMAGE mboot_common_load_part_info %s\n", part_name);
...
int mboot_common_load_part(char *part_name, char *img_name, uint32_t addr)
{
	...
	part_hdr_t *part_hdr;
        ...
        pal_log_err("ZBOOT LOAD_IMAGE mboot_common_load_part %s\n", part_name);
...
int mboot_android_load_recoveryimg_hdr(char *part_name, uint32_t addr)
{
	...
	pal_log_err("ZBOOT LOAD_IMAGE mboot_android_load_recoveryimg_hdr %s\n", part_name);
...
int mboot_android_load_recoveryimg(char *part_name, uint32_t addr)
{
  ...
  pal_log_err("ZBOOT LOAD_IMAGE mboot_android_load_recoveryimg %s\n", part_name);
				 ...
				 uint32_t size)
{
	...
	pal_log_err("ZBOOT LOAD_IMAGE mboot_recovery_load_raw_part %s\n", part_name);
...
uint32_t mboot_get_img_size(char *part_name, uint32_t *size)
{
	...
	*size = 0;
	...
	pal_log_err("ZBOOT LOAD_IMAGE mboot_get_img_size %s\n", part_name);
