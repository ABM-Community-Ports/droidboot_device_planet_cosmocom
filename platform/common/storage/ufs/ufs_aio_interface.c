...
__WEAK status_t interface_get_ufs_info(struct ufs_info_struct* info)
{
	...
	if (info->pre_eol_info == 0x3 || info->life_time_est_a >= 0xa || info->life_time_est_b >= 0xa)
		...
		info->life_time_status = LIFE_CYCLE_NORMAL;
